...
function onEachFeature(feature, layer) {
  ...
  if (name !== "Current Service Area" && name !== "NO VOTE"){
    container.on('click', '#vote', function(event) {
        ...
        window.open('https://docs.google.com/forms/d/e/1FAIpQLScFTotYxll3qMohE3cupQje91P42B3nbw44LI2HvwZar-MzMA/formResponse?usp=pp_url&ifq&entry.473915152='+name+'&entry.183451837='+$('#email').val()+'&submit=submit', '_blank');
    });
